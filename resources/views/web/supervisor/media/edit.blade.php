        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-4 text-center mb-3 mb-md-0">
                     {{-- نفس كود عرض الوسائط من ملف تعديل المدير --}}
                ...
                <div class="col-md-8">
                     <form action="{{ route('supervisor.media.update', $medium) }}" method="POST"> {{-- مسار المشرف --}}
                        @csrf
                        @method('PUT')
                        ...
                        <h5 class="mt-4 mb-3 border-top pt-3">تعديل الربط (مقيد بفصولك)</h5>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select class="form-select @error('associated_class_id') is-invalid @enderror" id="associated_class_id" name="associated_class_id">
                                    ...
                                    @foreach($classes as $id => $name) {{-- $classes هنا تحتوي فصول المشرف --}}
                            ...
                            {{-- الربط بطفل (أطفال المشرف فقط) --}}
                             <div class="col-md-4 mb-3">
                                ...
                                <select class="form-select @error('associated_child_id') is-invalid @enderror" id="associated_child_id" name="associated_child_id">
                                    ...
                                    @foreach($children as $child) {{-- $children هنا تحتوي أطفال المشرف --}}
