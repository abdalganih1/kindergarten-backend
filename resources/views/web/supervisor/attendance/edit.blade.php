...
<div class="container-fluid">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('supervisor.attendance.update', $attendance->attendance_id) }}" method="POST"> {{-- مسار المشرف --}}
                @csrf
                @method('PUT')
                ...
                <div class="mt-4 d-flex justify-content-end">
                     <a href="{{ route('supervisor.attendance.index', ['date' => $attendance->attendance_date]) }}" class="btn btn-secondary me-2">إلغاء</a> {{-- مسار المشرف --}}
