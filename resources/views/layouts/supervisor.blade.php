...
<head>
    ...
    <style>
        ...
        body {
            ...
            padding-top: 56px; /* <-- إضافة هذا السطر */ /* اضبط القيمة لتناسب ارتفاع شريط التنقل لديك */
...
<body>
    <div id="app">
        ...
        <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark flex-md-nowrap p-0 shadow">
            <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6" href="{{ route('supervisor.dashboard') }}">
                    ...
                    <div class="position-sticky pt-3">
                        <ul class="nav flex-column">
                            <li class="nav-item">
                             ...
                             <li class="nav-item">
                                <a class="nav-link {{ request()->routeIs('supervisor.attendance.*') ? 'active' : '' }}" href="{{ route('supervisor.attendance.index') }}">
                            ...
                            {{-- إدارة حالات الوجبات --}}
                            <li class="nav-item">
                                <a class="nav-link {{ request()->routeIs('supervisor.meal_statuses.*') ? 'active' : '' }}" href="{{ route('supervisor.meal_statuses.create') }}">
                                    <span data-feather="coffee"></span> {{-- أيقونة مناسبة --}}
                                    تسجيل حالات الوجبات
                                </a>
                            </li>
                             <li class="nav-item">
                                <a class="nav-link {{ request()->routeIs('supervisor.children.*') ? 'active' : '' }}" href="{{ route('supervisor.children.index') }}">
                                    <span data-feather="users"></span>
                                    إدارة الأطفال
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link {{ request()->routeIs('supervisor.events.*') ? 'active' : '' }}" href="{{ route('supervisor.events.index') }}">
                                    <span data-feather="calendar"></span>
                                    عرض الفعاليات
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link {{ request()->routeIs('supervisor.resources.*') ? 'active' : '' }}" href="{{ route('supervisor.resources.index') }}">
                                    <span data-feather="book-open"></span>
                                    المصادر التعليمية
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link {{ request()->routeIs('supervisor.health-records.*') ? 'active' : '' }}" href="{{ route('supervisor.health-records.index') }}">
                                    <span data-feather="heart"></span> {{-- أو shield أو activity --}}
                                    السجلات الصحية
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link {{ request()->routeIs('supervisor.media.*') ? 'active' : '' }}" href="{{ route('supervisor.media.index') }}">
                            ...
                            <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('supervisor.schedules.*') ? 'active' : '' }}" href="{{ route('supervisor.schedules.index') }}">
                        <span data-feather="calendar"></span> الجدول الاسبوعي
                    </a>
                </li>
                        </ul>
